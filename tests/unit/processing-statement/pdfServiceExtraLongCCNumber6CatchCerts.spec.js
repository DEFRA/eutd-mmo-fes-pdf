    ...
    test('should create the expected pdf', async () => {
		...
		const data = {
			"catches": [
				{
					"species": "Cod",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900001",
				...
				{
					"species": "Tuna",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900002",
					"totalWeightLanded": "100",
					"exportWeightBeforeProcessing": "100",
					"exportWeightAfterProcessing": "100"
				},
				{
					"species": "Haddock",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900003",
					"totalWeightLanded": "100",
					"exportWeightBeforeProcessing": "100",
					"exportWeightAfterProcessing": "100"
				},
				{
					"species": "Pilchard",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900004",
					"totalWeightLanded": "100",
					"exportWeightBeforeProcessing": "100",
					"exportWeightAfterProcessing": "100"
				},
				{
					"species": "Marlin",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900005",
					"totalWeightLanded": "100",
					"exportWeightBeforeProcessing": "100",
					"exportWeightAfterProcessing": "100"
				},
				{
					"species": "Grouper",
					"catchCertificateNumber": "CC-456789012345678901234567890123456789012345678900006",
					"totalWeightLanded": "100",
					"exportWeightBeforeProcessing": "100",
					"exportWeightAfterProcessing": "100"
				}
