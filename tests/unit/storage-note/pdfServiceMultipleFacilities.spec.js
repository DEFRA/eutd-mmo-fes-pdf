            ...
            storageFacilities: [
                {
                    ...
                    facilityAddressTwo: '',
                    facilityTownCity: 'Town A',
                    facilityPostcode: 'AA11AA',
                    storedAs: "frozen"
                },
                {
                    facilityName: 'Storage Facility 2',
                    facilityAddressOne: '30',
                    facilityAddressTwo: '',
                    facilityTownCity: 'Town B',
                    facilityPostcode: 'BB22BB',
                    storedAs: "chilled"
                },
                {
                    facilityName: 'Storage Facility 3',
                    facilityAddressOne: '30',
                    facilityAddressTwo: '',
                    facilityTownCity: 'Town C',
                    facilityPostcode: 'CC33CC',
                    storedAs: "both"
                }
            ],
            transport: {
