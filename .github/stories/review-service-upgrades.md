...
### Upgrades applied (all tests pass)

| Package | Change | Method |
| :-- | :-- | :-- |
| `fast-xml-parser` | transitive (stack overflow vuln) | `npm audit fix` |
| `minimatch` | transitive (ReDoS vuln) | `npm audit fix` |
| `muhammara` | 6.0.0 → 6.0.4 (bundled `tar` ≤7.5.7 vuln) | targeted upgrade |
| `@azure/storage-blob` | 12.30.0 → 12.31.0 | minor upgrade |
| `cryptr` | 6.3.0 → 6.4.0 | patch upgrade |

### Skipped (major version jumps — out of scope)

| Package | Current | Latest | Reason |
| :-- | --: | --: | :-- |
| `cross-env` | 7.0.3 | 10.1.0 | major |
| `dotenv` | 16.4.5 | 17.3.1 | major |
| `jest` | 29.7.0 | 30.2.0 | major |
| `pdfkit` | 0.15.1 | 0.17.2 | minor in 0.x — risky, no vuln |
...
- No `build` script in this repo
- `npm test` → 89 suites, 376 tests ✅
